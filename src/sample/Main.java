...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        mainVbox.getChildren().addAll(titleLabel, startButton, newQuestionButton, importButton, exportButton, quitButton);
        mainVbox.setAlignment(Pos.TOP_CENTER);
        mainVbox.setSpacing(10);

        // add question is a vbox holding hboxes
        VBox addQuestionVbox = new VBox();
        addQuestionVbox.getChildren().addAll(addQuestionTitle, hb2, hb3, hb4, hb5, hb6, hb7, hb8, hb9, hb10, hb11);
